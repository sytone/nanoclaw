---
name: add-ollama-tool-agent
description: Migrated from .claude skill add-ollama-tool for GitHub Copilot agent usage.
---

# add-ollama-tool Sync and Migration Agent

Source of truth: .claude/skills/add-ollama-tool/SKILL.md
Working copy: .github/skills/add-ollama-tool/SKILL.md
Agent file: .github/agents/add-ollama-tool.agent.md
