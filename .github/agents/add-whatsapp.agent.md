---
name: add-whatsapp-agent
description: Migrated from .claude skill add-whatsapp for GitHub Copilot agent usage.
---

# add-whatsapp Sync and Migration Agent

Source of truth: .claude/skills/add-whatsapp/SKILL.md
Working copy: .github/skills/add-whatsapp/SKILL.md
Agent file: .github/agents/add-whatsapp.agent.md
