---
name: use-local-whisper-agent
description: Migrated from .claude skill use-local-whisper for GitHub Copilot agent usage.
---

# use-local-whisper Sync and Migration Agent

Source of truth: .claude/skills/use-local-whisper/SKILL.md
Working copy: .github/skills/use-local-whisper/SKILL.md
Agent file: .github/agents/use-local-whisper.agent.md
