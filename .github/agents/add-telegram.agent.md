---
name: add-telegram-agent
description: Migrated from .claude skill add-telegram for GitHub Copilot agent usage.
---

# add-telegram Sync and Migration Agent

Source of truth: .claude/skills/add-telegram/SKILL.md
Working copy: .github/skills/add-telegram/SKILL.md
Agent file: .github/agents/add-telegram.agent.md
