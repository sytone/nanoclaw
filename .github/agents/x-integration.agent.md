---
name: x-integration-agent
description: Migrated from .claude skill x-integration for GitHub Copilot agent usage.
---

# x-integration Sync and Migration Agent

Source of truth: .claude/skills/x-integration/SKILL.md
Working copy: .github/skills/x-integration/SKILL.md
Agent file: .github/agents/x-integration.agent.md
