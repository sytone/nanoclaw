---
name: setup-agent
description: Migrated from .claude skill setup for GitHub Copilot agent usage.
---

# setup Sync and Migration Agent

Source of truth: .claude/skills/setup/SKILL.md
Working copy: .github/skills/setup/SKILL.md
Agent file: .github/agents/setup.agent.md
...
- Claude brand rename: 3
- Anthropic brand rename: 1
