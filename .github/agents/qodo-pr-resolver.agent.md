---
name: qodo-pr-resolver-agent
description: Migrated from .claude skill qodo-pr-resolver for GitHub Copilot agent usage.
---

# qodo-pr-resolver Sync and Migration Agent

Source of truth: .claude/skills/qodo-pr-resolver/SKILL.md
Working copy: .github/skills/qodo-pr-resolver/SKILL.md
Agent file: .github/agents/qodo-pr-resolver.agent.md
