---
name: add-discord-agent
description: Migrated from .claude skill add-discord for GitHub Copilot agent usage.
---

# add-discord Sync and Migration Agent

Source of truth: .claude/skills/add-discord/SKILL.md
Working copy: .github/skills/add-discord/SKILL.md
Agent file: .github/agents/add-discord.agent.md
