...
description: Migrated from .claude skill customize for GitHub Copilot agent usage.
---

# customize Sync and Migration Agent

Source of truth: .claude/skills/customize/SKILL.md
Working copy: .github/skills/customize/SKILL.md
Agent file: .github/agents/customize.agent.md
