---
name: convert-to-apple-container-agent
description: Migrated from .claude skill convert-to-apple-container for GitHub Copilot agent usage.
---

# convert-to-apple-container Sync and Migration Agent

Source of truth: .claude/skills/convert-to-apple-container/SKILL.md
Working copy: .github/skills/convert-to-apple-container/SKILL.md
Agent file: .github/agents/convert-to-apple-container.agent.md
