---
name: get-qodo-rules-agent
description: Migrated from .claude skill get-qodo-rules for GitHub Copilot agent usage.
---

# get-qodo-rules Sync and Migration Agent

Source of truth: .claude/skills/get-qodo-rules/SKILL.md
Working copy: .github/skills/get-qodo-rules/SKILL.md
Agent file: .github/agents/get-qodo-rules.agent.md
