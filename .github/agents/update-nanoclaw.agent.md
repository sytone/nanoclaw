---
name: update-nanoclaw-agent
description: Migrated from .claude skill update-nanoclaw for GitHub Copilot agent usage.
---

# update-nanoclaw Sync and Migration Agent

Source of truth: .claude/skills/update-nanoclaw/SKILL.md
Working copy: .github/skills/update-nanoclaw/SKILL.md
Agent file: .github/agents/update-nanoclaw.agent.md
