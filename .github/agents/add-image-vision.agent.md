---
name: add-image-vision-agent
description: Migrated from .claude skill add-image-vision for GitHub Copilot agent usage.
---

# add-image-vision Sync and Migration Agent

Source of truth: .claude/skills/add-image-vision/SKILL.md
Working copy: .github/skills/add-image-vision/SKILL.md
Agent file: .github/agents/add-image-vision.agent.md
