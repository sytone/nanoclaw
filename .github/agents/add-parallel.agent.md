---
name: add-parallel-agent
description: Migrated from .claude skill add-parallel for GitHub Copilot agent usage.
---

# add-parallel Sync and Migration Agent

Source of truth: .claude/skills/add-parallel/SKILL.md
Working copy: .github/skills/add-parallel/SKILL.md
Agent file: .github/agents/add-parallel.agent.md
...
- CLAUDE memory file rename: 3
- OAuth env var rename: 2
- API key env var rename: 2
