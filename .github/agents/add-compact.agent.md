---
name: add-compact-agent
description: Migrated from .claude skill add-compact for GitHub Copilot agent usage.
---

# add-compact Sync and Migration Agent

Source of truth: .claude/skills/add-compact/SKILL.md
Working copy: .github/skills/add-compact/SKILL.md
Agent file: .github/agents/add-compact.agent.md
