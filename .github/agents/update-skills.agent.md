...
description: Migrated from .claude skill update-skills for GitHub Copilot agent usage.
---

# update-skills Sync and Migration Agent

Source of truth: .claude/skills/update-skills/SKILL.md
Working copy: .github/skills/update-skills/SKILL.md
Agent file: .github/agents/update-skills.agent.md
