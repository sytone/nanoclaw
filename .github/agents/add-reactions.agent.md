---
name: add-reactions-agent
description: Migrated from .claude skill add-reactions for GitHub Copilot agent usage.
---

# add-reactions Sync and Migration Agent

Source of truth: .claude/skills/add-reactions/SKILL.md
Working copy: .github/skills/add-reactions/SKILL.md
Agent file: .github/agents/add-reactions.agent.md
