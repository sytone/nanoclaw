...
description: Migrated from .claude skill add-slack for GitHub Copilot agent usage.
---

# add-slack Sync and Migration Agent

Source of truth: .claude/skills/add-slack/SKILL.md
Working copy: .github/skills/add-slack/SKILL.md
Agent file: .github/agents/add-slack.agent.md
