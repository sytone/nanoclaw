---
name: add-pdf-reader-agent
description: Migrated from .claude skill add-pdf-reader for GitHub Copilot agent usage.
---

# add-pdf-reader Sync and Migration Agent

Source of truth: .claude/skills/add-pdf-reader/SKILL.md
Working copy: .github/skills/add-pdf-reader/SKILL.md
Agent file: .github/agents/add-pdf-reader.agent.md
