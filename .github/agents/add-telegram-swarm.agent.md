---
name: add-telegram-swarm-agent
description: Migrated from .claude skill add-telegram-swarm for GitHub Copilot agent usage.
---

# add-telegram-swarm Sync and Migration Agent

Source of truth: .claude/skills/add-telegram-swarm/SKILL.md
Working copy: .github/skills/add-telegram-swarm/SKILL.md
Agent file: .github/agents/add-telegram-swarm.agent.md
