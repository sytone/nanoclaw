---
name: debug-agent
description: Migrated from .claude skill debug for GitHub Copilot agent usage.
---

# debug Sync and Migration Agent

Source of truth: .claude/skills/debug/SKILL.md
Working copy: .github/skills/debug/SKILL.md
...
- Claude brand rename: 12
- CLAUDE memory file rename: 1
- OAuth env var rename: 6
- API key env var rename: 6
