...
description: Add image vision to NanoClaw agents. Resizes and processes WhatsApp image attachments, then sends them to GitHub Copilot as multimodal content blocks.
---
