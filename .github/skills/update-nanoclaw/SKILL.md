...
Run `/update-nanoclaw` in GitHub Copilot Code.
...
Present these buckets to the user and ask them to choose one path using ask_user:
...
- Use ask_user to ask the user which migration skills they want to run now. Options:
...
- Use ask_user to ask: "Upstream has skill branches. Would you like to check for skill updates?"
