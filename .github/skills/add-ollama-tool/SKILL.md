...
This skill adds a stdio-based MCP server that exposes local Ollama models as tools for the container agent. GitHub Copilot remains the orchestrator but can offload work to local models.
