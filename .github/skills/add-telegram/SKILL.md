...
Use `ask_user` to collect configuration:

ask_user: Do you have a Telegram bot token, or do you need to create one?
...
After completing the Telegram setup, use `ask_user`:

ask_user: Would you like to add Agent Swarm support? Without it, Agent Teams still work — they just operate behind the scenes. With Swarm support, each subagent appears as a different bot in the Telegram group so you can see who's saying what and have interactive team sessions.
